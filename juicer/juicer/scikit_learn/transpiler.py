...
import juicer.scikit_learn.audio_operation as audio_ops
...
class ScikitLearnTranspiler(Transpiler):
    ...
    def _assign_operations(self):
        ...
        data_ops = {
            ...
            'read-audio-folder': audio_ops.ReadAudioFolderOperation,
            'read-embedded-folder': audio_ops.ReadEmbeddingFolderOperation,
            'extract-audio-features': audio_ops.ExtractAudioFeatureOperation,
            'search-database': audio_ops.SearchDatabaseOperation,
            'process':audio_ops.ProcessOperation,
            'denoise':audio_ops.DenoiseOperation,
