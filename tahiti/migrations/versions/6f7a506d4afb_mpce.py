...
def _insert_operation_form_field():
    ...
    data = [
        #Flatten - data_format
        (9001, 'folder_column', 'TEXT', 1, 1, 'folder_column', 'text', None, None, 'EXECUTION', 9001, None),
        (9002, 'image_column', 'TEXT', 1, 2, 'image_column', 'text', None, None, 'EXECUTION', 9001, None),
        (9003, 'image_prefix', 'TEXT', 1, 1, 'image_prefix', 'text', None, None, 'EXECUTION', 9002, None),
        (9004, 'image_column', 'TEXT', 1, 2, 'image_column', 'text', None, None, 'EXECUTION', 9002, None),
        (9005, 'feature_column', 'TEXT', 1, 2, 'feature_column', 'text', None, None, 'EXECUTION', 9003, None),
        (9006, 'image_column', 'TEXT', 1, 2, 'image_column', 'text', None, None, 'EXECUTION', 9003, None),
        (9007, 'face_column', 'TEXT', 1, 1, 'face_column', 'text', None, None, 'EXECUTION', 9002, None),
        (9008, 'face_location_column', 'TEXT', 1, 2, 'face_location_column', 'text', None, None, 'EXECUTION', 9002, None),
        (9009, 'descriptors', 'TEXT', 1, 1, 'descriptors', 'text', None, None, 'EXECUTION', 9004, None),
        (9010, 'prediction', 'TEXT', 0, 2, 'prediction', 'text', None, None, 'EXECUTION', 9004, None),
        (9011, 'threshold', 'DECIMAL', 0, 3, 0.5, 'decimal', None, None, 'EXECUTION', 9004, None),
        (9012, 'image_column', 'TEXT', 1, 1, 'image_column', 'text', None, None, 'EXECUTION', 9005, None),
        (9013, 'label_column', 'TEXT', 1, 1, 'label_column', 'text', None, None, 'EXECUTION', 9005, None),
        (9014, 'grid_coordinates', 'TEXT', 0, 20, None,'grid-coordinates', None, None, 'EXECUTION', 9005, None),
        (9015, 'normalize', 'INTEGER', 1, 3, 0, 'checkbox', None, None, 'EXECUTION', 9002, None),
